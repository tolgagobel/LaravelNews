    ...
    <div class="app-menu navbar-menu">
        ...
        <div class="navbar-brand-box">
            ...
            <a href="" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="../backend/assets/images/logo.png" alt="" height="22">
                    </span>
                <span class="logo-lg">
                        <img src="../backend/assets/images/logo.png" alt="" height="17">
                    </span>
            </a>
            <!-- Light Logo-->
            <a href="" class="logo logo-light">
                ...
                <span class="logo-lg">
                        <img src="../backend/assets/images/logo.png" alt="" height="37">
                    </span>
            </a>
...
<!-- Editor -->
<script src="https://cdn.ckeditor.com/ckeditor5/27.0.1/classic/ckeditor.js"></script>
@yield('scripts')
<!-- JAVASCRIPT -->
