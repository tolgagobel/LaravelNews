...
class MainController extends Controller
{
    public function index(){
        ...
        $product_goster_one_cikan = ProductDetail::with('product')->where('goster_one_cikan', 1)->take(10)->get();
        $product_goster_cok_satan = ProductDetail::with('product')->where('goster_cok_satan', 1)->take(10)->get();
        $product_goster_indirimli = ProductDetail::with('product')->where('goster_indirimli', 1)->take(10)->get();


        return view('frontend.index',compact('categories','product_slider','product_gunun_firsati',
